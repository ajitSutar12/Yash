<?php
    ...
    $getInvocieNumber = mysqli_query($con,"select distinct invoice_id from invoice_master order by invoice_id desc");
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table  invoice-detail-table table-borderless ; invoice-detail-table" >
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="uptble" style = "white-space: inherit;text-align:left;width: 30%;" id="gst1"></td>
                                                                                </tr>   
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table  invoice-detail-table table-borderless ; invoice-detail-table" >
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="uptble" style = "width: 5%;">:</td>
                                                                                    <td class="uptble" style = "white-space: inherit;text-align:left;width: 30%;"><input type="date" name="invoice_date" class="form-control"></td>
                                                                                </tr>  
        
                                                                                <tr>
                                                                                    <td class="uptble" style = "text-align: left; width: 15%;">Challan No</td>
                                                                                    <td class="uptble" style = "width: 5%;">:</td>
                                                                                    <td class="uptble" style = "white-space: inherit;text-align:left;width: 30%;"><input type="text" name="challan_no"class="form-control"></td>
                                                                                </tr> 
                                                                                
                                                                                <tr>
                                                                                    <td class="uptble" style = "text-align: left; width: 15%;">Challan Date</td>
                                                                                    <td class="uptble" style = "width: 5%;">:</td>
                                                                                    <td class="uptble" style = "white-space: inherit;text-align:left;width: 30%;"><input type="date" name="challan_date" class="form-control"></td>
                                                                                </tr>   
        
                                                                                <tr>
                                                                                    <td class="uptble" style = "text-align: left; width: 15%;">Order No</td>
                                                                                    <td class="uptble" style = "width: 5%;">:</td>
                                                                                    <td class="uptble" style = "white-space: inherit;text-align:left;width: 30%;"><input type="text" name="order" class="form-control"></td>
                                                                                </tr>  
        
                                                                                <tr>
                                                                                    <td class="uptble" style = "text-align: left; width: 15%;">Supplier Code</td>
                                                                                    <td class="uptble" style = "width: 5%;">:</td>
                                                                                    <td class="uptble" style = "white-space: inherit;text-align:left;width: 30%;"><input type="text" name="supplier" class="form-control"></td>
                                                                                </tr> 

                                                                                <tr>
                                                                                    <td class="uptble" style = "text-align: left; width: 15%;">Despatch</td>
                                                                                    <td class="uptble" style = "width: 5%;">:</td> 
                                                                                    <td class="uptble" style = "white-space: inherit;text-align:left;width: 30%;"><input type="text" name="dispatch" class="form-control"></td>
                                                                                </tr> 
                                                            ...
                                                            <div class="table-responsive " style="overflow:hidden; width= 102"  >
                                                                <div class="table-responsive" style="margin-top: 15px;">
                                                                    ...
                                                                    <table class="table  invoice-detail-table table-bordered ; invoice-detail-table;    margin-bottom: 5px;" >
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="table_td" style="color:black; border-color:black;" colspan="4"> (Labour Charges Only)  <input type="radio" id="male" name="gender" value="Yes">
                                                                            ...
                                                                            <tr>
                                                                                <td class="table_td" style="color:black; border-color:black;" colspan="4"><textarea class="from-control" name="note" style="width: 100%;"></textarea> </td>

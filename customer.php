                  ...
                  <div class="navbar-container container-fluid">
                      ...
                      <ul class="nav-right">
                            <li style="margin-top:3px;">
                                <span><a href="#"> <i class="fa fa-home"></i> Add Customer</a></span>
                            </li> 
                                                        ...
                                                        <form class="form-material" method="post" id="addCustomer">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        Mobile
                                                                        <input type="text" name="mobile" class="form-control" maxlength="10" pattern="[1-9]{1}[0-9]{9}" required="">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        Phone No.
                                                                        <input type="text" name="phone" class="form-control" maxlength="10" pattern="[0-9]{1}[0-9]{9}">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        GSTIN
                                                                        <input type="text" name="gst" id="gst" class="form-control" required="" onkeyup="gstPanShipping('default');this.value = this.value.toUpperCase();" pattern="\d{2}[A-Z]{5}\d{4}[A-Z]{1}[A-Z\d]{1}[Z]{1}[A-Z\d]{1}">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        PAN NO.
                                                                        <input type="text"  name="pan" id="pan" class="form-control" required="" pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
                                                            </div>

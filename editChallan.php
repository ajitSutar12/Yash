<?php
    ...
    $getInvocieNumber = mysqli_query($con,"select * from challan_master where challan_id =  $id");
    $row3             = mysqli_fetch_assoc($getInvocieNumber);

    $challan_id        = $row3['challan_id'];
    $challan_date      = $row3['challan_date'];
    $cust_id           = $row3['cust_id'];
    $matter            = $row3['matter'];
    $delivery          = $row3['delivery'];
    $gurrenty          = $row3['gurrenty'];
    $transport         = $row3['transport'];
                  ...
                  <div class="navbar-container container-fluid">
                      ...
                      <ul class="nav-right">
                            <li style="margin-top:3px;">
                                <span><a href="#"> <i class="fa fa-home"></i> Update Challan</a></span>
                            </li> 
                                                                ...
                                                                <div class="table-responsive" style="margin-top: 15px;">
                                                                    <table class="table  invoice-detail-table table-bordered ; invoice-detail-table;    margin-bottom: 5px;" id="myTable">
                                                                        ...
                                                                        <?php 
                                                                                    ...
                                                                                    $getMaterialDetails = mysqli_query($con,"select * from challan_master where challan_id='$challan_id'");
        ...
        $('#ganerateInvoice').submit(function (e) {
            ...
            $.ajax({
                ...
                success : function(result)
                {
                    ...
                    if(result.result == 'success')
                    {
                        swal("Save!", "Challan update Successfully", "success");
        ...
        $("#myTable").on("click", "#DeleteButton", function(e) {
            ...
            swal({
                    ...
                    if (willDelete) {
                        ...
                        total();
                        $.ajax({
                            url      : 'ajax/DeleteChallanMaterial.php',
                            type     : 'post',
                            dataType : 'json',
                            data     : { id : id[1]},
                            success  : function(result)
                            {
                                if(result.result == 'success')
                                {
                                    swal("Save!", "Challan Material Delete  Successfully", "success");

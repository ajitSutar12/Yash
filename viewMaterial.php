                  ...
                  <div class="navbar-container container-fluid">
                      ...
                      <ul class="nav-right">
                            <li style="margin-top:3px;">
                                <span><a href="#"> <i class="fa fa-home"></i> View Material</a></span>
                            </li> 
                ...
                if (isConfirm) {
                    $.ajax({
                        ...
                        success : function(result)
                        {
                            ...
                            {
                                swal("Save!", "Material Deleted Successfully", "success");
                                $.ajax({
                                    url   : 'ajax/materialData.php',
                                    type  : 'post',
                                    success : function(result)

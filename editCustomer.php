<?php 
    ...
    $getCustomerDetails = mysqli_query($con,"select * from customer_master where id = $custID");
                  ...
                  <div class="navbar-container container-fluid">
                      ...
                      <ul class="nav-right">
                            <li style="margin-top:3px;">
                                <span><a href="#"> <i class="fa fa-home"></i> Edit Customer</a></span>
                            </li> 
                ...
                <nav class="pcoded-navbar">
                    <div class="pcoded-inner-navbar">
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li class="pcoded-hasmenu">
                                <a href="viewCustomer.php" class="waves-effect waves-dark">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material" method="post" id="addCustomer">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        Mobile
                                                                        <input type="text" name="mobile" value="<?php echo $mobile; ?>" class="form-control" maxlength="10" pattern="[1-9]{1}[0-9]{9}" required="">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        Phone No.
                                                                        <input type="text" name="phone" value="<?php echo $phone?>" class="form-control" maxlength="10" pattern="[0-9]{1}[0-9]{9}">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-8">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        GSTIN
                                                                        <input type="text" name="gst" id="gst" value="<?php echo $gst?>" class="form-control" required="" onkeyup="gstPanShipping('default');this.value = this.value.toUpperCase();" pattern="\d{2}[A-Z]{5}\d{4}[A-Z]{1}[A-Z\d]{1}[Z]{1}[A-Z\d]{1}">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        PAN NO.
                                                                        <input type="text"  name="pan" id="pan" value="<?php echo $pan?>" class="form-control" required="" readonly pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        $('#addCustomer').submit(function (e) {
            ...
            $.ajax({
                ...
                success : function(result)
                {
                    ...
                    {
                        swal("Save!", "Customer Update Successfully", "success");

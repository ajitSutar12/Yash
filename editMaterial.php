<?php
    ...
    $getMaterialDetails = mysqli_query($con,"select * from material_master where id=$material_id");
    $row                = mysqli_fetch_assoc($getMaterialDetails);
                  ...
                  <div class="navbar-container container-fluid">
                      ...
                      <ul class="nav-right">
                            <li style="margin-top:3px;">
                                <span><a href="#"> <i class="fa fa-home"></i> Edit Material</a></span>
                            </li> 
                                                        ...
                                                        <form class="form-material" method="post" id="addMaterial">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        Material Name
                                                                        <input type="hidden" name="materialID" value="<?php echo $material_id?>">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        HSN Code
                                                                        <input type="text" name="hsn" value="<?php echo $hsn ?>" class="form-control" required="">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        SGST
                                                                        <input type="number" name="sgst" value="<?php echo $sgst ?>" class="form-control" required="">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        CGST
                                                                        <input type="number" name="cgst" value="<?php echo $cgst ?>" class="form-control" required="">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        IGST
                                                                        <input type="number" name="igst" value="<?php echo $igst ?>" class="form-control">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <div class="form-group form-primary">
                                                                        Weight
                                                                        <input type="number" name="weight" value="<?php echo $weight ?>" class="form-control" required="">
                                                                        <span class="form-bar"></span>
                                                                    </div>
                                                                </div>
        ...
        $('#addMaterial').submit(function (e) {
            ...
            $.ajax({
                ...
                success : function(result)
                {
                    ...
                    {
                        swal("Save!", "Material Update Successfully", "success");
